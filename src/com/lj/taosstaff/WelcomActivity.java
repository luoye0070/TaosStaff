...
import com.lj.taosstaff.model.ApplicationVersionInfo;

import com.lj.taosstaff.filerw.FileReadWrite;
import com.lj.taosstaff.internet.HttpConnectionHelper;
import com.lj.taosstaff.string_analysis.AnalyzeXmlHelper;
import com.lj.taosstaff.string_analysis.AppVersionInfoAnalyzeHelper;
	...
	private void keepActivityThenStart(int keepTime)
	{
		...
		try {
	        ...
	        public void run() { 
	            ...
	            Intent mainIntent = new Intent(WelcomActivity.this,LoginActivity.class); 
...
//				newAppVInfo=axh.getAppVInfo();
				...
				int vCode=this.getPackageManager().getPackageInfo("com.lj.taosstaff", 0).versionCode;
