package com.lj.taosstaff.include;
...
import com.lj.taosstaff.MainActivity;
...
//			break;
		case AppConstant.MNMAIndex.DishListActivity:			
			mainNavbar_dishListBt.setBackgroundDrawable(a.getResources().getDrawable(R.drawable.navbar_menu_dishlist_press));
			mainNavbar_dishListBt.setTextColor(Color.parseColor("#e67323"));
			break;
		case AppConstant.MNMAIndex.ReserveActivity:			
			mainNavbar_reserveBt.setBackgroundDrawable(a.getResources().getDrawable(R.drawable.navbar_menu_message_press));
...
//		});
		...
		mainNavbar_reserveBt.setOnClickListener(new OnClickListener() {			
			...
			public void onClick(View v) {
				...
				reserveIntent.setClass(a.getApplicationContext(), MessageListActivity.class);
